<div class="row">
    <div class="col-12 col-md-8">
        ...
        <div class="mb-3">
            ...
            <textarea type="text" rows="2" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" placeholder="Ingrese descripción de la categoría">{{ old('descripcion', $producto->descripcion ?? '') }}
            </textarea>
            @error('descripcion')
            <span class="error text-danger">{{ $message }}</span>
            @enderror
        ...
        <div class="mb-3 row">
            <div class="col-6">
                ...
                <select class="form-select @error('sub_categoria_id') is-invalid @enderror" id="sub_categoria_id" name="sub_categoria_id">
            ...
            <div class="col-6">
                ...
                <select class="form-select @error('public_target_id') is-invalid @enderror" id="public_target_id" name="public_target_id">
                    <option value="null">Seleccione una categoria</option>
    ...
    <div class="col-12 col-md-4 pt-2 h-auto">
        <div class="position-relative p-4 text-center text-muted bg-body border rounded-5 h-100 center-div">
            ...
            <div class="container-file">
                ...
                <input type="file" id="thumbnail" style="display:none" accept="image/*" onchange="previewImage(event)" name="thumbnail" id="thumbnail">
                @error('thumbnail')
    ...
    <div class="col-12 col-md-4 pt-2">
        ...
        <a href="{{ route('productos.index') }}" class="btn btn-warning" onclick="clearLocalStorage()">Cancelar</a>
    </div>
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const existingImage = "{{ $producto->thumbnail ?? '' }}";
        let imageField = document.getElementById("imagePreview");
        imageField.innerHTML = '';
